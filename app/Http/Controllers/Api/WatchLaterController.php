...
class WatchLaterController extends Controller
{
    ...
    public function destroy(Request $request, $video)
    {
        ...
        $removed = WatchLater::removeFromWatchLater(Auth::id(), (int) $video);

        return response()->json([
            'success' => $removed,
            'message' => $removed ? 'Video rimosso da Guarda più tardi' : 'Video non presente in watch later'
        ], $removed ? 200 : 404);
    }
