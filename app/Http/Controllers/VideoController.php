...
class VideoController extends Controller
{
    ...
    public function update(Request $request, Video $video)
    {
        $request->validate([
            ...
            'description' => 'nullable|string|max:2000',
            'is_public' => 'boolean',
            'status' => 'required|in:published,draft,pending_approval',
    ...
    public function getAdjacentReel(Request $request, Video $video)
    {
        ...
        return response()->json([
            ...
            'reel' => [
                ...
                'thumbnail_url' => $adjacentReel->thumbnail_url,
        ...
        try {
            ...
            return response()->json([
                ...
                'reel' => [
                    ...
                    'thumbnail_url' => $randomReel->thumbnail_url,
        ...
        try {
            ...
            $reelsData = $reels->map(function ($reel) {
                return [
                    ...
                    'video_path' => $reel->video_file_url,
