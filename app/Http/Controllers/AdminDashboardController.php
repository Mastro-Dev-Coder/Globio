...
class AdminDashboardController extends Controller
{
    ...
    public function content(Request $request)
    {
        ...
        $newVideos = Video::with(['user:id,name', 'user.userProfile:user_id,channel_name,avatar_url'])
            ->where('published_at', '>=', $startDate)
            ->orderBy('published_at', 'desc')
            ->paginate(20);

        $popularVideos = Video::with(['user:id,name', 'user.userProfile:user_id,channel_name,avatar_url'])
            ->where('published_at', '>=', $startDate)
    ...
    public function analytics(Request $request)
    {
        ...
        $dailyAnalytics = $performanceTrends;
