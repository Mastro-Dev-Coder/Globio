...
class VideoProcessingStartedNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Elaborazione Video iniziata: ' . $video->title)
            ->greeting('Ciao ' . $notifiable->name)
            ->line('Il tuo video "' . $video->title . '"sta venendo caricato ')
    ...
    public function toDatabase(object $notifiable): array
    {
        ...
        return [
            ...
            'excerpt' => str($this->video->description)->limit(80),
