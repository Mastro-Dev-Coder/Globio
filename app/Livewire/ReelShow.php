    ...
    public function findCurrentIndex(): void
    {
        ...
        if ($currentVideoInReels !== false) {
            ...
            array_unshift($this->reels, [
                ...
                'thumbnail_url' => $this->currentVideo->thumbnail_url,
                'video_url' => $this->currentVideo->video_file_url,
                'video_path' => $this->currentVideo->video_file_url,
                'thumbnail_path' => $this->currentVideo->thumbnail_url,
