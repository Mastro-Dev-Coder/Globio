            ...
            <div class="grid items-start gap-8 lg:grid-cols-[1.2fr_0.8fr]">
                <div class="rounded-[2rem] border border-yellow-400/20 bg-white/5 p-8 shadow-2xl shadow-black/30 backdrop-blur">
                    ...
                    <h1 class="mt-5 max-w-2xl text-4xl font-black tracking-tight text-white sm:text-5xl">
                        Video e reels senza pubblicita, con controlli e funzioni in piu.
                    </h1>
                    <p class="mt-5 max-w-2xl text-base leading-7 text-gray-300 sm:text-lg">
                        Un abbonamento mensile in stile YouTube: meno interruzioni, piu qualita, piu comfort su video lunghi e reels.
                    </p>
                ...
                <aside class="rounded-[2rem] border border-white/10 bg-slate-900/90 p-8 shadow-2xl shadow-black/30">
                    ...
                    <div class="mt-8">
                        @auth
                            @if ($hasPremium)
                                <div class="rounded-2xl border border-emerald-400/20 bg-emerald-400/10 p-4 text-sm text-emerald-100">
                                    Hai gia un abbonamento premium attivo.
                                ...
                                <form method="POST" action="{{ route('premium.portal') }}" class="mt-4">
                                    @csrf
                        ...
                        <p class="mt-4 text-xs leading-6 text-gray-400">
                            Rinnovo mensile automatico. Puoi gestire o annullare il piano dal portale cliente quando disponibile.
                        </p>
                    </div>
                </aside>
            </div>
