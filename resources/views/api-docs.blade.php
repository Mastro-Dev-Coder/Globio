<x-layout>
        ...
        $groups = [
            [
                ...
                'endpoints' => [
                    ...
                    ['method' => 'POST', 'path' => '/auth/logout', 'auth' => 'Si', 'params' => 'Bearer token in header'],
                ],
            ],
            [
                ...
                'endpoints' => [
                    ...
                    ['method' => 'GET', 'path' => '/videos/{id_or_slug}/comments', 'auth' => 'No', 'params' => 'path param'],
                    ['method' => 'GET', 'path' => '/creators', 'auth' => 'No', 'params' => 'q?, per_page?'],
                    ['method' => 'GET', 'path' => '/creators/{id_or_username_or_channel_slug}', 'auth' => 'No', 'params' => 'path param'],
            ...
            [
                ...
                'description' => 'Azioni utente su video e creators.',
                'endpoints' => [
                    ['method' => 'POST', 'path' => '/videos/{id_or_slug}/comments', 'auth' => 'Si', 'params' => 'content, parent_id?'],
                    ['method' => 'POST', 'path' => '/videos/{id_or_slug}/reaction', 'auth' => 'Si', 'params' => 'reaction: like|dislike|none'],
                    ['method' => 'POST', 'path' => '/creators/{id_or_username_or_channel_slug}/subscribe', 'auth' => 'Si', 'params' => 'toggle subscribe'],
                    ['method' => 'POST', 'path' => '/videos/{id_or_slug}/share', 'auth' => 'Si', 'params' => 'get share data'],
                ],
            ],
            [
                ...
                'endpoints' => [
                    ...
                    ['method' => 'POST', 'path' => '/me/watch-later/{id_or_slug}', 'auth' => 'Si', 'params' => 'path param'],
                    ['method' => 'DELETE', 'path' => '/me/watch-later/{id_or_slug}', 'auth' => 'Si', 'params' => 'path param'],
            ...
            [
                ...
                'endpoints' => [
                    ['method' => 'GET', 'path' => '/me/subscriptions', 'auth' => 'Si', 'params' => 'canali a cui sei iscritto'],
                    ['method' => 'GET', 'path' => '/me/subscribers', 'auth' => 'Si', 'params' => 'iscritti al tuo canale'],
                ],
            ],
            [
                ...
                'endpoints' => [
                    ['method' => 'GET', 'path' => '/me/videos', 'auth' => 'Si', 'params' => 'type?, status?, per_page?'],
                    ...
                    ['method' => 'POST', 'path' => '/posts/create', 'auth' => 'Si', 'params' => 'title, video_file, thumbnail?, description?'],
                    ['method' => 'PUT', 'path' => '/videos/{video}', 'auth' => 'Si', 'params' => 'title?, description?, is_public?, status?, comments_enabled?, likes_enabled?'],
                    ['method' => 'DELETE', 'path' => '/videos/{video}', 'auth' => 'Si', 'params' => 'elimina video'],
                    ['method' => 'GET', 'path' => '/videos/{video}/status', 'auth' => 'Si', 'params' => 'stato elaborazione'],
                    ['method' => 'POST', 'path' => '/videos/bulk', 'auth' => 'Si', 'params' => 'action, video_ids[]'],
                ],
            ],
            [
                'title' => 'Comments (Auth)',
                ...
                'endpoints' => [
                    ...
                    ['method' => 'POST', 'path' => '/comments/{comment}/like', 'auth' => 'Si', 'params' => 'like/unlike commento'],
                    ['method' => 'DELETE', 'path' => '/comments/{comment}', 'auth' => 'Si', 'params' => 'elimina commento'],
                ],
            ],
            [
                'title' => 'Notifications (Auth)',
                'description' => 'Gestione notifiche user.',
                'endpoints' => [
                    ['method' => 'GET', 'path' => '/me/notifications', 'auth' => 'Si', 'params' => '-'],
                    ['method' => 'POST', 'path' => '/me/notifications/read-all', 'auth' => 'Si', 'params' => '-'],
                    ['method' => 'POST', 'path' => '/me/notifications/{id}/read', 'auth' => 'Si', 'params' => 'path param id'],
                ],
            ],
            [
                ...
                'endpoints' => [
                    ...
                    ['method' => 'PUT', 'path' => '/me/settings', 'auth' => 'Si', 'params' => 'email_notifications?, push_notifications?, private_profile?'],
                ],
            ],
            [
                ...
                'endpoints' => [
                    ['method' => 'GET', 'path' => '/settings', 'auth' => 'No', 'params' => 'configurazione app completa'],
                    ...
                    ['method' => 'GET', 'path' => '/settings/languages', 'auth' => 'No', 'params' => 'lingue supportate'],
                ],
            ],
        ];
    ...
    <section class="min-h-screen bg-slate-950 px-4 py-8 sm:px-6 lg:px-8">
        <div class="mx-auto w-full max-w-7xl">
            <div class="relative overflow-hidden rounded-3xl border border-slate-700/50 bg-gradient-to-br from-slate-900 via-slate-900 to-sky-950 p-6 shadow-2xl shadow-black/30 sm:p-10">
                <div class="pointer-events-none absolute -top-20 -right-20 h-72 w-72 rounded-full bg-sky-500/20 blur-3xl"></div>
                <div class="pointer-events-none absolute -bottom-20 -left-16 h-72 w-72 rounded-full bg-cyan-400/20 blur-3xl"></div>
                ...
                <div class="relative">
                    ...
                    <h1 class="mt-4 text-3xl font-bold tracking-tight text-white sm:text-4xl">Flutter Integration API v1</h1>
