    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ __('ui.admin_comments_total') }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ __('ui.admin_comments_today') }}</p>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ __('ui.admin_comments_this_week') }}</p>
                        <p class="text-xl font-semibold text-gray-900 dark:text-white">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-3">
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-400">{{ __('ui.admin_comments_this_month') }}</p>
                        <p class="text-xl font-semibold text-gray-900 dark:text-white">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
            <form method="GET" action="{{ route('admin.comments') }}" class="flex items-center space-x-4">
                <input type="text" name="search" placeholder="{{ __('ui.admin_comments_search_placeholder') }}" value="{{ $search ?? '' }}"
                ...
                <button type="submit"
                    ...
                    <i class="fas fa-search mr-2"></i>{{ __('ui.admin_comments_search') }}
                </button>
            </form>
        </div>
        ...
        <div
            ...
            <div class="p-6 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ __('ui.admin_comments_list_title') }}</h3>
            </div>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            ...
                                            <div class="text-sm text-gray-500 dark:text-gray-400">
                                                {{ number_format($comment->video->views_count) }} {{ __('ui.views') }}
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                    ...
                                    <div class="flex items-center space-x-2">
                                        @if ($comment->video && $comment->video->status === 'published')
                                            <a href="{{ route('videos.show', $comment->video) }}" target="_blank"
                                                ...
                                                title="{{ __('ui.admin_comments_view_video') }}">
                                        ...
                                        <a href="{{ route('admin.users.show', $comment->user) }}"
                                            ...
                                            title="{{ __('ui.admin_comments_user_profile') }}">
                                            <i class="fas fa-user"></i>
                                        </a>

                                        <form method="POST" action="{{ route('admin.comments.delete', $comment) }}"
                                            class="inline"
                                            onsubmit="return confirm(@json(__('ui.admin_comments_delete_confirm')))">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                                                class="text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300"
                                                title="{{ __('ui.admin_comments_delete') }}">
                            ...
                            <tr>
                                <td colspan="5" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center">
                                        ...
                                        <p class="text-gray-500 dark:text-gray-400">{{ __('ui.admin_comments_none') }}</p>
                                    </div>
                                </td>
                            </tr>
                        @endforelse
