        ...
        <form method="POST"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="name" value="{{ old('name', ($advertisement ? $advertisement->name : '') ?? '') }}"
                            required placeholder="{{ __('ui.admin_ads_name_placeholder') }}"
                    ...
                    <div>
                        ...
                        <select name="position" required
                            ...
                            <option value="home_video"
                                ...
                                {{ __('ui.admin_ads_position_home_video') }}
                            </option>
            ...
            <div class="flex items-center justify-end space-x-4">
                ...
                <button type="submit"
                    ...
                    {{ $advertisement ? __('ui.admin_ads_update') : __('ui.admin_ads_create') }} {{ __('ui.admin_ads_table_ad') }}
                </button>
            </div>
        </form>
    </div>
