...
<aside id="desktop-sidebar"
    class="globio-sidebar fixed left-0 top-2 bottom-0 z-30 hidden lg:block w-64 overflow-y-auto overscroll-contain bg-transparent text-gray-600 dark:text-gray-300">
    <div class="p-4">
        <!-- Main Navigation -->
        <nav class="space-y-2">
            <a href="{{ route('home') }}"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const storageKey = 'globio.sidebar.scrollTop';
