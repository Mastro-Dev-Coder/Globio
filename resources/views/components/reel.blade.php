<div class="group cursor-pointer relative p-2 rounded-xl w-full max-w-sm sm:max-w-md" data-color-wrapper-trending data-color-card style="--hover-color: rgba(120, 120, 120, 0.14)">
